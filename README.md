[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/TPQKLU27)
...
7. Lakukan automasi dengan membuat DAG dengan kriteria :
   ...
   - Penjadwalan dilakukan setiap hari Sabtu jam 09:10 AM hingga 09:30 AM dan dilakukan per 10 menit. Tabel dibawah ini adalah contoh hasil penjadwalannya :| No | Execution Time                      |
     | -- | ----------------------------------- |
...
5. Jelaskan apa if (doc['educational_qualifications.keyword'].value == 'Uneducated') return 1;
   else if (doc['educational_qualifications.keyword'].value == 'School') return 2;
   else if (doc['educational_qualifications.keyword'].value == 'Graduate') return 3;
   else if (doc['educational_qualifications.keyword'].value == 'Post Graduate') return 4;
   else return 5;iyang Anda ketahui dari Great Expectations menggunakan pemahaman dan bahasa Anda sendiri !
...
>>>>>>> 35a45b9a12a63faffcd777afc741b94989f78d90
>>>>>>>
>>>>>>
>>>>>
>>>>
